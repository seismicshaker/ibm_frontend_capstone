...
import "./Sign_Up.css"; // Importing the CSS styles for the Sign_Up component

// Defining the Function component Sign_Up
const Sign_Up = () => {
...
export default Sign_Up; // Exporting the Sign_Up component to be used in other parts of the application